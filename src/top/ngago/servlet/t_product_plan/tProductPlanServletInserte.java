...
@WebServlet("/user/tProductPlanServletInserte")
public class tProductPlanServletInserte extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //执行update操作
        int inserter = t_product_plan_dao.inserter(t_product_plan);
